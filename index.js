...
console.log("connecting akindu md...");
...
console.log('𝙻𝙾𝚁𝙳 𝚇𝙼𝙳 𝙲𝙾𝙽𝙽𝙴𝙲𝚃𝙴𝙳 𝚃𝙾 𝚆𝙷𝙰𝚃𝚂𝙰𝙿𝙿 𝙴𝙽𝙹𝙾𝚈 ✅')
...
> *AKINDU MD*`;
conn.sendMessage(conn.user.id, { image: { url: `
`https://i.ibb.co/nMky5xTB/7341.jpg }, caption: up })
...
app.get("/", (req, res) => {
res.send("AKINDU MD is 𝙲𝙾𝙽𝙽𝙴𝙲𝚃𝙴𝙳 ✅");
});
